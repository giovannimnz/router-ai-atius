...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/:id/codex/credential", permission: authz.ChannelRead, handler: controller.GetCodexChannelCredential},
	...
	{method: http.MethodPost, path: "/:id/codex/regenerate/device/start", permission: authz.ChannelSensitiveWrite, handler: controller.StartCodexDeviceOAuthForChannel},
	{method: http.MethodPost, path: "/:id/codex/regenerate/device/poll", permission: authz.ChannelSensitiveWrite, handler: controller.PollCodexDeviceOAuthForChannel},
	{method: http.MethodPost, path: "/:id/codex/regenerate/device/cancel", permission: authz.ChannelSensitiveWrite, handler: controller.CancelCodexDeviceOAuthForChannel},
	{method: http.MethodPost, path: "/:id/codex/regenerate/start", permission: authz.ChannelSensitiveWrite, handler: controller.StartCodexOAuthForChannel},
	{method: http.MethodPost, path: "/:id/codex/regenerate/complete", permission: authz.ChannelSensitiveWrite, handler: controller.CompleteCodexOAuthForChannel},
	{method: http.MethodPost, path: "/:id/codex/probe", permission: authz.ChannelOperate, handler: controller.ProbeCodexChannelCredential},
