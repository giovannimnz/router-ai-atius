...
func EndpointTypeLabel(endpointType constant.EndpointType) string {
	...
	case constant.EndpointTypeEmbeddings:
		return "Embeddings"
	case constant.EndpointTypeReranker, constant.EndpointTypeJinaRerank:
		return "Reranker"
...
func EndpointRoutes(endpointTypes []constant.EndpointType) map[string]string {
	...
	for _, endpointType := range endpointTypes {
		endpointType = constant.NormalizeEndpointType(endpointType)
...
func HasEndpointType(endpointTypes []constant.EndpointType, wanted constant.EndpointType) bool {
	wanted = constant.NormalizeEndpointType(wanted)
	for _, endpointType := range endpointTypes {
		if constant.NormalizeEndpointType(endpointType) == wanted {
			return true
		}
	}
	return false
