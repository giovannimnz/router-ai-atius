...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/codex/oauth/device/start", controller.StartDeviceAuth)
			channelRoute.POST("/codex/oauth/device/poll", controller.PollDeviceAuth)
			channelRoute.POST("/codex/oauth/device/upload", controller.UploadDeviceAuthJSON)
			channelRoute.POST("/codex/models", controller.FetchCodexModels)
