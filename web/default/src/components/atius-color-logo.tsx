...
export function AtiusColorLogo(props: { size?: number; className?: string }) {
  ...
  return (
    <svg
      ...
      role='img'
      aria-labelledby='atius-color-title atius-color-desc'
    >
      <title id='atius-color-title'>Atius</title>
      <desc id='atius-color-desc'>Dark green letter A with a gold letter C.</desc>
