...
> = {
  // ATIUS: title and description tuned for the Atius AI Router
  en: {
    default: 'Atius AI Router - Production-Ready LLM Gateway',
    template: '%s | Atius AI Router',
    description:
      'Aggregate 40+ AI providers behind a single OpenAI/Anthropic-compatible API. Built on QuantumNous/new-api, hardened for production.',
  },
  zh: {
    default: 'Atius AI Router - 生产就绪的 LLM 网关',
    template: '%s | Atius AI Router',
    description:
      '将 40+ AI 提供商聚合到统一的 OpenAI / Anthropic 兼容 API 之后。基于 QuantumNous/new-api，专为生产环境。',
  },
  ja: {
    default: 'Atius AI Router - 本番運用対応 LLM ゲートウェイ',
    template: '%s | Atius AI Router',
    description:
      '40 以上の AI プロバイダーを単一の OpenAI / Anthropic 互換 API に集約。QuantumNous/new-api をベースに、本番環境向けに。',
  },
};
