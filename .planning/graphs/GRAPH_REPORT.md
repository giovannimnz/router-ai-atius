...
Cohesion: 0.06
Nodes (32): GetAllTask(), GetUserTask(), Context, Task, TaskDto, tasksToDto(), Properties, SyncTaskQueryParams (+24 more)
...
Cohesion: 0.17
Nodes (30): cmd_api(), cmd_call(), cmd_codex_catalog(), cmd_coverage(), cmd_endpoint_list(), cmd_endpoint_show(), cmd_resources(), cmd_status() (+22 more)
...
Cohesion: 0.10
Nodes (48): unescapeMapOrSlice(), unescapeString(), EnsureExactModelMetadata(), readOptionMapValue(), cloneCodexOpenAIReferencePrice(), cloneCodexOpenAIReferencePricingSnapshot(), codexOpenAIPricedModelIDs(), codexOpenAIReferenceModelURL() (+40 more)
...
Cohesion: 0.12
Nodes (15): ShouldPreserveThinkingSuffix(), AudioRequest, ClaudeRequest, Context, EmbeddingRequest, Adaptor, GeminiChatRequest, GeneralOpenAIRequest (+7 more)
...
Cohesion: 0.11
Nodes (8): MediaContent, Message, FileSource, MediaContent, MessageFile, MessageImageUrl, MessageInputAudio, MessageVideoUrl
...
Cohesion: 0.09
Nodes (12): __dirname, require, semiDateFnsDir, semiUiDir, { app, BrowserWindow, dialog, Tray, Menu, shell }, fs, http, path (+4 more)
...
Cohesion: 0.18
Nodes (10): Community Hubs (Navigation), Corpus Check, God Nodes (most connected - your core abstractions), Graph Freshness, Graph Report - router-codex-metadata  (2026-07-19), Import Cycles, Knowledge Gaps, Suggested Questions (+2 more)
...
Cohesion: 0.49
Nodes (9): health_ok(), load_optional_env_var(), log(), recover_cached_plan(), recover_stale_pod_storage(), require_cmd(), service_logs(), wait_healthy() (+1 more)
...
Cohesion: 0.22
Nodes (8): Conclusion, Integration and Flows, Milestone v2.17 Audit - Codex OAuth lifecycle and upstream auth diagnostics, Non-Blocking Debt, Phase Verification, Requirement Cross-Reference, Result, Validation Evidence
...
Cohesion: 0.31
Nodes (8): CacheGetChannel(), CacheGetChannelInfo(), CacheUpdateChannel(), CacheUpdateChannelStatus(), filterChannelsByRequestPath(), GetRandomSatisfiedChannel(), Channel, ChannelInfo
...
Cohesion: 0.25
Nodes (7): Out Of Scope, PHASE-27-CODEX-CI-AUTH, PHASE-27-OFFICIAL-DOCS-FIRST, PHASE-27-PTBR-RELEASE-OPS-DOCS, Phase 27 Requirements, Requirements Archive: v2.17 Codex OAuth lifecycle and upstream auth diagnostics, REQUIREMENTS - Router AI Atius Go-only model routing
...
Cohesion: 0.75
Nodes (7): configure_remotes(), die(), ensure_actions_repo(), ensure_local_fork_remote(), push_fork(), workflow_run(), fork-sync-guard.sh script
...
Cohesion: 0.47
Nodes (5): DISABLE_ESLINT_PLUGIN, require_file(), retry(), VITE_REACT_APP_VERSION, ci-build-frontends.sh script
...
Cohesion: 0.25
Nodes (7): Coleta automatica de pricing, Contrato API-key separado, Contrato canônico, Gates de validacao, Hermes Agent, OpenAI Codex OAuth: contexto e pricing canônico no Router, Persistencia de limites
...
Cohesion: 0.70
Nodes (4): has_deterministic_failure(), print_release_summary(), usage(), check-release-actions.sh script
...
Cohesion: 0.83
Nodes (3): print_summary(), usage(), gh-actions-watchdog.sh script
