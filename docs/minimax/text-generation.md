    ...
    ChatCompletionReq:
      ...
      properties:
        model:
          type: string
          description: >-
            Model ID. Options: `MiniMax-M2.7`, `MiniMax-M2.7-highspeed`,
            `MiniMax-M2.5`, `MiniMax-M2.5-highspeed`, `MiniMax-M2.1`,
            `MiniMax-M2`. `MiniMax-M2.7`, `MiniMax-M2.7-highspeed`,
            `MiniMax-M2.5`, `MiniMax-M2.5-highspeed`, `MiniMax-M2.1` and
            `MiniMax-M2` are reasoning models, recommended with streaming output
